...
public class SyncOVRGrabber : MonoBehaviourPun
{
    ...
    protected SyncOVRGrabbable m_grabbedObj = null;
    ...
    /// </summary>
    public SyncOVRGrabbable grabbedObject
    {
        get { return m_grabbedObj; }
    }

    public void ForceRelease(SyncOVRGrabbable grabbable)
    {
        bool canRelease = (
            (m_grabbedObj != null) &&
    ...
    protected virtual void GrabBegin()
    {
        ...
        SyncOVRGrabbable closestGrabbable = null;
        Collider closestGrabbableCollider = null;

        // Iterate grab candidates and find the closest grabbable candidate
        foreach (SyncOVRGrabbable grabbable in m_grabCandidates.Keys)
        {
    ...
    protected virtual void OffhandGrabbed(SyncOVRGrabbable grabbable)
    {
